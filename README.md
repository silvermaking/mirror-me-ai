...
같은 방향으로 위험 구역을 피해 AI 보스에게 거짓 확신을 심고, 예측이 잠긴 뒤 반대로 빠져 코어를 직접 베는 짧은 2.5D 액션 게임입니다.

**회피 규칙:** 공격이 끝날 때 플레이어 발밑의 청록점이 주황·자홍 위험 구역 밖이면 회피 성공입니다. WASD와 대시 모두 사용할 수 있으며, 대시는 무적이 아니라 빠른 이동입니다.
